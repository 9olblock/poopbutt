          ...
          <div className='mx-auto w-full max-w-7xl'>
            <div className='py-8'>
              ...
              <a href="/" className='bg-opacity-100 bg-[#00468C] duration-200 items-center px-4 h-7 pt-0.5 mx-1 hover:bg-opacity-70 rounded'>
                ...
                <nav>
                  <ul className='flex items-center cursor-pointer justify-center pt-0'>
                    <li>
                    ...
                    <a className='
                              bg-opacity-20 
                              text-white opacity-80  relative h-7  font-mono tracking-wider pt-0.5 first::pt-0  uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> 
                              THE MOON
                      </a>
                    </li>
                    <li>
