...
<div className="page-wrapper font-Nippo">
      ...
      <div className='flex-col items-stretch justify-center w-full h-24 fixed'>
        <div className='relative px-10 z-1'>
          <div className='mx-auto w-full max-w-7xl'>
            <div className='py-8'>
              <div className='flex align-middle justify-between static text-white'>
                <a href="/" className='bg-opacity-100 bg-[#00468C] duration-200 items-center px-4 h-7 pt-0.5 mx-1 hover:bg-opacity-70 rounded'>
                MOONBIRD
                </a>
                <nav>
                  <ul className='flex items-center justify-center pt-0'>
                    <li>
                      <a href="/about" className='bg-opacity-70 
                              text-white opacity-80  relative h-7  font-mono tracking-wider pt-0.5 first::pt-0 placeholder:uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> ABOUT
                      </a>
                    </li>
                    <li>
                    <a className='
                              bg-opacity-20 
                              text-white opacity-80 relative h-7  font-mono tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> THE MOON
                      </a>
                    </li>
                    <li>
                    <a href="/roadmap" className='bg-opacity-20 
                              text-white opacity-80  relative h-7  font-mono tracking-wider pt-0.5 first::pt-0  uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> ROADMAP
                      </a>
                    </li>
                    <li>
                    <a className='bg-opacity-20 
                              text-white opacity-80  relative h-7  font-mono tracking-wider pt-0.5 first::pt-0  uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> TEAM
                      </a>
                    </li>
                    <li>
                    <a className='bg-opacity-20 
                              text-white opacity-80 relative h-7  font-mono tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> RARITY
                      </a>
                    </li>
                    <li>
                    <a className='bg-opacity-20 
                              text-white opacity-80 relative h-7  font-mono tracking-wider pt-0.5 first::pt-0  uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 mx-1 hover:bg-opacity-70 rounded  flex justify-center flex-row'> MOON POWER
                      </a>
                    </li>
                  </ul>
                ...
                <ul className='flex space-x-2'>
                      <li>
                          <a className='
                            ...
                            } items-center relative h-7 items-center font-mono tracking-wider pt-0 first::pt-0 duration-1000 uppercase text-2xs font-500 padding-huge bg-white duration-200 items-center px-4 hover:bg-opacity-70 rounded  flex justify-center flex-row'>
                                <svg xmlns='http://www.w3.org/2000/svg' className=' fill-white stroke-white h-4 w-4' viewBox='0 0 40 40'>
                    ...
                    <div className='py-12'>
                        <div>
                            <div className='flex-col items-stretch justify-start'>
                                <div className='max-w-2xl text-white font-bold text-6xl'>
                                    ABOUT
                                    <div className='mt-2 text-[#9e9a9a] text-xl font-normal'>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eleifend leo id lectus varius, non facilisis mi maximus.
                                    </div>
                                </div>
                                <div>
                                    <div className='mt-14 relative '>
                                        <div className='flex flex-col max-w-10xl mx-auto space-y-4'>
                                            <div className='flex space-x-2  clip-your-needful-style text-white -skew-x-0 -skew-y-0 place-content-start justify-start'>
                                                <div className="bg-[#00468C] flex-col sm:h-[50vh] py-3 w-full h-[80vh] bg-cover bg-[url('/public/Moonbird3.png')] border-4 border-[#white] hover:bg-center hover:text-xl hover:cursor-pointer">
                                                    <div className='px-2'>THIS IS A BOX</div>


                                                    <div className='bg-gradient-to-t from-black w-full sm:h-[50vh]'></div>

                                                </div>
                                                <div className="bg-[#00468C] sm:h-[50vh] py-3 w-full h-[80vh] bg-cover bg-[url('/public/MoonBird.png')] border-4 border-[#white] hover:bg-center hover:text-xl hover:cursor-pointer">
                                                <div className='px-2'>THIS IS A BOX</div>

                                                <div className='bg-gradient-to-t from-black w-full sm:h-[50vh]'></div>
                                                </div>
                                                <div className="bg-[#00468C] sm:h-[50vh] py-3 w-full h-[80vh] bg-cover bg-[url('/public/Moonbird4.png')] border-4 border-[#white] hover:bg-center hover:text-xl hover:cursor-pointer">
                                                <div className='px-2'>THIS IS A BOX</div>

                                                <div className='bg-gradient-to-t from-black w-full sm:h-[50vh]'></div>
                                                </div>
                                                <div className="bg-[#00468C] sm:h-[50vh] py-3 w-full h-[80vh] bg-cover bg-[url('/public/Moonbird3.png')] border-4 border-[#white] hover:bg-center hover:text-xl hover:cursor-pointer">
                                                <div className='px-2'>THIS IS A BOX</div>
